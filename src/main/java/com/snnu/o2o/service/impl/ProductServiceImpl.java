...
import com.snnu.o2o.dao.ProductDao;
import com.snnu.o2o.dao.ProductImgDao;
import com.snnu.o2o.dto.ImageHolder;
import com.snnu.o2o.dto.ProductExecution;
import com.snnu.o2o.entity.Product;
import com.snnu.o2o.entity.ProductImg;
import com.snnu.o2o.enums.ProductStateEnum;
import com.snnu.o2o.exception.ProductOperationException;
import com.snnu.o2o.service.ProductService;
import com.snnu.o2o.util.ImageUtil;
import com.snnu.o2o.util.PageCalculator;
import com.snnu.o2o.util.PathUtil;
...
public class ProductServiceImpl implements ProductService {
	...
	public ProductExecution getProductList(Product productCondition, int pageIndex, int pageSize) {
		// 页码转化成数据库的行数,并调用dao层取回指定页码的商品列表
